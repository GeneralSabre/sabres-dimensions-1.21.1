...
public class IndustrialFurnaceBlock extends BlockWithEntity implements BlockEntityProvider {

    public static final BooleanProperty ACTIVE = BooleanProperty.of("active");
    public static final DirectionProperty FACING = Properties.HORIZONTAL_FACING;


    public static final MapCodec<IndustrialFurnaceBlock> INDUSTRIAL_CODEC = IndustrialFurnaceBlock.createCodec(IndustrialFurnaceBlock::new);

    public IndustrialFurnaceBlock(Settings settings) {
        super(settings);
    ...
    protected void onStateReplaced(BlockState state, World world, BlockPos pos, BlockState newState, boolean moved) {
        if (state.getBlock() != newState.getBlock()) {
            ...
            if (blockEntity instanceof IndustrialFurnaceBlockEntity) {
                ItemScatterer.spawn(world, pos, ((IndustrialFurnaceBlockEntity) blockEntity));
    ...
    protected ItemActionResult onUseWithItem(ItemStack stack, BlockState state, World world, BlockPos pos,
        ...
        if (!world.isClient) {
            NamedScreenHandlerFactory screenHandlerFactory = ((IndustrialFurnaceBlockEntity) world.getBlockEntity(pos));
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        ...
        return validateTicker(type, ModBlockEntities.INDUSTRIAL_FURNACE_BE,
