...
public class IndustrialFurnaceScreenHandler extends ScreenHandler {
    ...
    private final IndustrialFurnaceBlockEntity blockEntity;

    public IndustrialFurnaceScreenHandler(int syncId, PlayerInventory inventory, BlockPos pos) {
    ...
    public IndustrialFurnaceScreenHandler(int syncId, PlayerInventory playerInventory,
        ...
        super(ModScreenHandlers.INDUSTRIAL_FURNACE_SCREEN_HANDLER, syncId);
